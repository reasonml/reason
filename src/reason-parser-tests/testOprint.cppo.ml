...
module Convert = Migrate_parsetree.Convert (Migrate_parsetree.OCaml_406) (Migrate_parsetree.OCaml_current)
module ConvertBack = Migrate_parsetree.Convert (Migrate_parsetree.OCaml_current) (Migrate_parsetree.OCaml_406)
...
let main () =
  ...
  let phrase = (Ast_406.Outcometree.Ophr_signature
