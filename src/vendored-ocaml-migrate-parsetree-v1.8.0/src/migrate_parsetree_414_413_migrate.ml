...
and copy_with_constraint :
  ...
  | Ast_414.Parsetree.Pwith_modtype (_, x1) ->
      migration_error x1.Ast_414.Parsetree.pmty_loc With_modtype
  | Ast_414.Parsetree.Pwith_modtypesubst (_, x1) ->
      migration_error x1.Ast_414.Parsetree.pmty_loc With_modtypesubst
...
and copy_signature_item_desc :
  ...
  | Ast_414.Parsetree.Psig_modtypesubst x0 ->
      migration_error x0.Ast_414.Parsetree.pmtd_loc Psig_modtypesubst
