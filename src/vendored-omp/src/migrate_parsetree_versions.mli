...
(** A version of the OCaml frontend packs the ast with type witnesses so that
    equalities can be recovered dynamically. *)
type _ witnesses
(*IF_AT_LEAST 406 = private ..*)
...
module OCaml_56 : OCaml_version with module Ast = Ast_56

val ocaml_56 : OCaml_56.types ocaml_version
(*$*)
