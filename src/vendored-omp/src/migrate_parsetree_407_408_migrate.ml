...
and copy_out_phrase :
  Ast_407.Outcometree.out_phrase -> Ast_408.Outcometree.out_phrase =
  function
...
and copy_out_sig_item :
  Ast_407.Outcometree.out_sig_item -> Ast_408.Outcometree.out_sig_item =
  function
  ...
  | Ast_407.Outcometree.Osig_ellipsis -> Ast_408.Outcometree.Osig_ellipsis
and copy_out_val_decl :
  Ast_407.Outcometree.out_val_decl -> Ast_408.Outcometree.out_val_decl =
  fun
...
and copy_out_type_decl :
  Ast_407.Outcometree.out_type_decl -> Ast_408.Outcometree.out_type_decl =
  fun
...
and copy_out_module_type :
  Ast_407.Outcometree.out_module_type -> Ast_408.Outcometree.out_module_type
  =
  function
  | Ast_407.Outcometree.Omty_abstract -> Ast_408.Outcometree.Omty_abstract
...
and copy_out_ext_status :
  Ast_407.Outcometree.out_ext_status -> Ast_408.Outcometree.out_ext_status =
  function
  | Ast_407.Outcometree.Oext_first -> Ast_408.Outcometree.Oext_first
  | Ast_407.Outcometree.Oext_next -> Ast_408.Outcometree.Oext_next
  | Ast_407.Outcometree.Oext_exception -> Ast_408.Outcometree.Oext_exception
...
and copy_private_flag :
  Ast_407.Asttypes.private_flag -> Ast_408.Asttypes.private_flag =
  function
  | Ast_407.Asttypes.Private -> Ast_408.Asttypes.Private
  | Ast_407.Asttypes.Public -> Ast_408.Asttypes.Public
and copy_out_rec_status :
  Ast_407.Outcometree.out_rec_status -> Ast_408.Outcometree.out_rec_status =
  function
  | Ast_407.Outcometree.Orec_not -> Ast_408.Outcometree.Orec_not
  | Ast_407.Outcometree.Orec_first -> Ast_408.Outcometree.Orec_first
  | Ast_407.Outcometree.Orec_next -> Ast_408.Outcometree.Orec_next
and copy_out_class_type :
  Ast_407.Outcometree.out_class_type -> Ast_408.Outcometree.out_class_type =
  function
...
and copy_out_type :
  Ast_407.Outcometree.out_type -> Ast_408.Outcometree.out_type =
  function
  | Ast_407.Outcometree.Otyp_abstract -> Ast_408.Outcometree.Otyp_abstract
  | Ast_407.Outcometree.Otyp_open -> Ast_408.Outcometree.Otyp_open
  ...
  | Ast_407.Outcometree.Otyp_stuff x0 -> Ast_408.Outcometree.Otyp_stuff x0
...
and copy_out_attribute :
  Ast_407.Outcometree.out_attribute -> Ast_408.Outcometree.out_attribute =
  fun { Ast_407.Outcometree.oattr_name = oattr_name } ->
    { Ast_408.Outcometree.oattr_name = oattr_name }
and copy_out_variant :
  Ast_407.Outcometree.out_variant -> Ast_408.Outcometree.out_variant =
  function
...
and copy_out_value :
  Ast_407.Outcometree.out_value -> Ast_408.Outcometree.out_value =
  function
  | Ast_407.Outcometree.Oval_array x0 ->
      Ast_408.Outcometree.Oval_array (List.map copy_out_value x0)
  | Ast_407.Outcometree.Oval_char x0 -> Ast_408.Outcometree.Oval_char x0
  | Ast_407.Outcometree.Oval_constr (x0, x1) ->
      Ast_408.Outcometree.Oval_constr
        ((copy_out_ident x0), (List.map copy_out_value x1))
  | Ast_407.Outcometree.Oval_ellipsis -> Ast_408.Outcometree.Oval_ellipsis
  | Ast_407.Outcometree.Oval_float x0 -> Ast_408.Outcometree.Oval_float x0
  | Ast_407.Outcometree.Oval_int x0 -> Ast_408.Outcometree.Oval_int x0
  | Ast_407.Outcometree.Oval_int32 x0 -> Ast_408.Outcometree.Oval_int32 x0
  | Ast_407.Outcometree.Oval_int64 x0 -> Ast_408.Outcometree.Oval_int64 x0
  ...
  | Ast_407.Outcometree.Oval_stuff x0 -> Ast_408.Outcometree.Oval_stuff x0
...
and copy_out_string :
  Ast_407.Outcometree.out_string -> Ast_408.Outcometree.out_string =
  function
  | Ast_407.Outcometree.Ostr_string -> Ast_408.Outcometree.Ostr_string
  | Ast_407.Outcometree.Ostr_bytes -> Ast_408.Outcometree.Ostr_bytes
and copy_out_ident :
  Ast_407.Outcometree.out_ident -> Ast_408.Outcometree.out_ident =
  function
  ...
  | Ast_407.Outcometree.Oide_ident x0 ->
