...
let add_nonrec rf attrs =
  ...
  | Recursive -> attrs
  | Nonrecursive ->
     let name = mknoloc "nonrec" in
     (name, PStr []) :: attrs

let partition_nonrec_attr attrs = List.partition (fun attr ->
    match attr with
    | ({txt="nonrec"; _}, _) -> true
    | _ -> false) attrs
...
let of_parsetree_arg_label = function
  | "" -> Nolabel
  | string when string.[0] = '?' -> Optional (String.sub string 1 (String.length string - 1))
  | string -> Labelled string


let rec to_parsetree_attribute (loc, payload) = (loc, to_parsetree_payload payload)

and of_parsetree_attribute (loc, payload) = (loc, of_parsetree_payload payload)
...
and of_parsetree_core_type item = {
    ptyp_desc= of_parsetree_core_type_desc item.Parsetree.ptyp_desc;
    ptyp_loc= item.Parsetree.ptyp_loc;
    ptyp_attributes= of_parsetree_attributes item.Parsetree.ptyp_attributes;
  }
...
and of_parsetree_core_type_desc = function
  ...
  | Parsetree.Ptyp_poly (string_loc_list, core_type) ->
     Ptyp_poly (
         List.map (fun string_loc -> mknoloc string_loc) string_loc_list,
         of_parsetree_core_type core_type
       )
...
and of_parsetree_expression item = {
    pexp_desc= of_parsetree_expression_desc item.Parsetree.pexp_desc;
    pexp_loc= item.Parsetree.pexp_loc;
    pexp_attributes= of_parsetree_attributes item.Parsetree.pexp_attributes;
  }
...
and of_parsetree_constant = function
  | Asttypes.Const_char c -> Pconst_char c
  | Asttypes.Const_string (s,d) -> Pconst_string (s,d)
...
and of_parsetree_expression_desc = function
  | Parsetree.Pexp_ident (longident_loc) ->
     Pexp_ident (longident_loc)

  | Parsetree.Pexp_constant constant ->
     Pexp_constant (of_parsetree_constant constant)

  | Parsetree.Pexp_let (rec_flag, value_binding_list, expression) ->
     Pexp_let (of_parsetree_rec_flag rec_flag,
               List.map of_parsetree_value_binding value_binding_list,
               of_parsetree_expression expression)

  | Parsetree.Pexp_function case_list ->
     Pexp_function (List.map of_parsetree_case case_list)

  | Parsetree.Pexp_fun (arg_label, expression_option, pattern, expression) ->
     Pexp_fun (of_parsetree_arg_label arg_label,
               map_option of_parsetree_expression expression_option,
               of_parsetree_pattern pattern,
               of_parsetree_expression expression)

  | Parsetree.Pexp_apply (expression, arg_label_expression_list) ->
     Pexp_apply (of_parsetree_expression expression,
                 List.map (fun (arg_label, expression) ->
                     (of_parsetree_arg_label arg_label,
                      of_parsetree_expression expression))
                          arg_label_expression_list)

  | Parsetree.Pexp_match (expression, case_list) ->
     Pexp_match (of_parsetree_expression expression, List.map of_parsetree_case case_list)

  | Parsetree.Pexp_try (expression, case_list) ->
     Pexp_try (of_parsetree_expression expression, List.map of_parsetree_case case_list)

  | Parsetree.Pexp_tuple expression_list ->
     Pexp_tuple (List.map of_parsetree_expression expression_list)

  | Parsetree.Pexp_construct (longident_loc, expression_option) ->
     Pexp_construct (longident_loc, map_option of_parsetree_expression expression_option)

  | Parsetree.Pexp_variant (label, expression_option) ->
     Pexp_variant (label, map_option of_parsetree_expression expression_option)

  | Parsetree.Pexp_record (longident_loc_expression_list, expression_option) ->
     Pexp_record (List.map (fun (longident_loc, expression) ->
                     (longident_loc,
                      of_parsetree_expression expression))
                           longident_loc_expression_list,
  ...
  | Parsetree.Pexp_field (expression, longident_loc) ->
     Pexp_field (of_parsetree_expression expression, longident_loc)

  | Parsetree.Pexp_setfield (expression1, longident_loc, expression2) ->
     Pexp_setfield (of_parsetree_expression expression1, longident_loc, of_parsetree_expression expression2)

  | Parsetree.Pexp_array expression_list ->
     Pexp_array (List.map of_parsetree_expression expression_list)

  | Parsetree.Pexp_ifthenelse (expression1, expression2, expression_option) ->
     Pexp_ifthenelse (of_parsetree_expression expression1,
                      of_parsetree_expression expression2,
                      map_option of_parsetree_expression expression_option)

  | Parsetree.Pexp_sequence (expression1, expression2) ->
     Pexp_sequence (of_parsetree_expression expression1,
                    of_parsetree_expression expression2)

  | Parsetree.Pexp_while (expression1, expression2) ->
     Pexp_while (of_parsetree_expression expression1,
                 of_parsetree_expression expression2)

  | Parsetree.Pexp_for (pattern, expression1, expression2, direction_flag, expression3) ->
     Pexp_for (of_parsetree_pattern pattern,
               of_parsetree_expression expression1,
               of_parsetree_expression expression2,
               of_parsetree_direction_flag direction_flag,
               of_parsetree_expression expression3)

  | Parsetree.Pexp_constraint (expression, core_type) ->
     Pexp_constraint (of_parsetree_expression expression, of_parsetree_core_type core_type)

  | Parsetree.Pexp_coerce (expression, core_type_option, core_type) ->
     Pexp_coerce (of_parsetree_expression expression,
                  map_option of_parsetree_core_type core_type_option,
                  of_parsetree_core_type core_type)


  | Parsetree.Pexp_send (expression, string_loc) ->
     Pexp_send (of_parsetree_expression expression, mknoloc string_loc)

  | Parsetree.Pexp_new (longident_loc) ->
     Pexp_new longident_loc

  | Parsetree.Pexp_setinstvar (string_loc, expression) ->
     Pexp_setinstvar (string_loc, of_parsetree_expression expression)

  | Parsetree.Pexp_override string_loc_expression_list ->
     Pexp_override (List.map (fun (string_loc, expression) ->
                        (string_loc,
                         of_parsetree_expression expression))
                             string_loc_expression_list)
  ...
  | Parsetree.Pexp_letmodule (string_loc, module_expr, expression) ->
     Pexp_letmodule (string_loc,
                     of_parsetree_module_expr module_expr,
                     of_parsetree_expression expression)

  | Parsetree.Pexp_assert expression ->
     Pexp_assert (of_parsetree_expression expression)

  | Parsetree.Pexp_lazy expression ->
     Pexp_lazy (of_parsetree_expression expression)

  | Parsetree.Pexp_poly (expression, core_type_option) ->
     Pexp_poly (of_parsetree_expression expression,
                map_option of_parsetree_core_type core_type_option)

  | Parsetree.Pexp_object class_structure ->
     Pexp_object (of_parsetree_class_structure class_structure)

  | Parsetree.Pexp_newtype (string_loc, expression) ->
     Pexp_newtype (mknoloc string_loc, of_parsetree_expression expression)


  | Parsetree.Pexp_pack module_expr ->
     Pexp_pack (of_parsetree_module_expr module_expr)

  | Parsetree.Pexp_open (override_flag, longident_loc, expression) ->
     Pexp_open (of_parsetree_override_flag override_flag,
                longident_loc,
                of_parsetree_expression expression)

  | Parsetree.Pexp_extension extension ->
     Pexp_extension (of_parsetree_extension extension)
...
and of_parsetree_case item = {
    pc_lhs= of_parsetree_pattern item.Parsetree.pc_lhs;
    pc_guard= map_option of_parsetree_expression item.Parsetree.pc_guard;
    pc_rhs= of_parsetree_expression item.Parsetree.pc_rhs;
  }
...
and of_parsetree_value_description item = {
    pval_name= item.Parsetree.pval_name;
    pval_type= of_parsetree_core_type item.Parsetree.pval_type;
    pval_prim= item.Parsetree.pval_prim;
    pval_attributes= of_parsetree_attributes item.Parsetree.pval_attributes;
    pval_loc= item.Parsetree.pval_loc;
  }
...
and of_parsetree_type_declaration item = {
    ptype_name= item.Parsetree.ptype_name;
    ptype_params=
      List.map (fun (core_type, variance) -> (
                  of_parsetree_core_type core_type,
                  of_parsetree_variance variance)
        ) item.Parsetree.ptype_params;
    ptype_cstrs=
      List.map (fun (core_type1, core_type2, location) -> (
                  of_parsetree_core_type core_type1,
                  of_parsetree_core_type core_type2,
        ...
        ) item.Parsetree.ptype_cstrs;
    ptype_kind= of_parsetree_type_kind item.Parsetree.ptype_kind;
    ptype_private= of_parsetree_private_flag item.Parsetree.ptype_private;
    ptype_manifest= map_option of_parsetree_core_type item.Parsetree.ptype_manifest;
    ptype_attributes= of_parsetree_attributes item.Parsetree.ptype_attributes;
    ptype_loc= item.Parsetree.ptype_loc;
  }
...
and of_parsetree_type_kind = function
  | Parsetree.Ptype_abstract ->
     Ptype_abstract

  | Parsetree.Ptype_variant constructor_declaration_list ->
     Ptype_variant (List.map of_parsetree_constructor_declaration constructor_declaration_list)

  | Parsetree.Ptype_record label_declaration_list ->
     Ptype_record (List.map of_parsetree_label_declaration label_declaration_list)
...
and of_parsetree_label_declaration item = {
     pld_name= item.Parsetree.pld_name;
     pld_mutable= of_parsetree_mutable_flag item.Parsetree.pld_mutable;
     pld_type= of_parsetree_core_type item.Parsetree.pld_type;
     pld_loc= item.Parsetree.pld_loc;
     pld_attributes= of_parsetree_attributes item.Parsetree.pld_attributes;
    }
...
and of_parsetree_constructor_declaration item = {
     pcd_name= item.Parsetree.pcd_name;
     pcd_args= of_parsetree_constructor_arguments item.Parsetree.pcd_args;
     pcd_res= map_option of_parsetree_core_type item.Parsetree.pcd_res;
     pcd_loc= item.Parsetree.pcd_loc;
     pcd_attributes= of_parsetree_attributes item.Parsetree.pcd_attributes;
    }
...
and of_parsetree_constructor_arguments args =
  Pcstr_tuple (List.map of_parsetree_core_type args)
...
and of_parsetree_package_type (location_loc, longident_loc_core_type_list)= (
  location_loc,
  List.map (fun (longident_loc, core_type)-> (
              longident_loc,
              of_parsetree_core_type core_type
...
and of_parsetree_row_field = function
  | Parsetree.Rtag (label, attributes, bool, core_type_list) ->
     Rtag (of_parsetree_label label,
           of_parsetree_attributes attributes,
           bool,
           List.map of_parsetree_core_type core_type_list
          )
  | Parsetree.Rinherit core_type ->
     Rinherit (of_parsetree_core_type core_type)
...
and of_parsetree_pattern item = {
    ppat_desc= of_parsetree_pattern_desc item.Parsetree.ppat_desc;
    ppat_loc= item.Parsetree.ppat_loc;
    ppat_attributes= of_parsetree_attributes item.Parsetree.ppat_attributes;
  }
...
and of_parsetree_pattern_desc = function
  | Parsetree.Ppat_any ->
     Ppat_any

  | Parsetree.Ppat_var string_loc ->
     Ppat_var string_loc

  | Parsetree.Ppat_alias (pattern, string_loc) ->
     Ppat_alias (of_parsetree_pattern pattern,
                 string_loc
                )

  | Parsetree.Ppat_constant constant ->
     Ppat_constant (of_parsetree_constant constant)

  | Parsetree.Ppat_interval (constant1, constant2) ->
     Ppat_interval (of_parsetree_constant constant1, of_parsetree_constant constant2)

  | Parsetree.Ppat_tuple pattern_list ->
     Ppat_tuple (List.map of_parsetree_pattern pattern_list)

  | Parsetree.Ppat_construct (longident_loc, pattern_option) ->
     Ppat_construct (longident_loc, map_option of_parsetree_pattern pattern_option)

  | Parsetree.Ppat_variant (label, pattern_option) ->
     Ppat_variant (of_parsetree_label label, map_option of_parsetree_pattern pattern_option)

  | Parsetree.Ppat_record (longident_loc_pattern_list, closed_flag) ->
     Ppat_record (
         List.map (fun (longident_loc, pattern) ->
             (longident_loc, of_parsetree_pattern pattern)
           ) longident_loc_pattern_list,
         of_parsetree_closed_flag closed_flag
       )

  | Parsetree.Ppat_array pattern_list ->
     Ppat_array (List.map of_parsetree_pattern pattern_list)

  | Parsetree.Ppat_or (pattern1, pattern2) ->
     Ppat_or (of_parsetree_pattern pattern1,
              of_parsetree_pattern pattern2
             )

  | Parsetree.Ppat_constraint (pattern, core_type) ->
     Ppat_constraint (of_parsetree_pattern pattern,
              of_parsetree_core_type core_type)

  | Parsetree.Ppat_type longident_loc ->
     Ppat_type (longident_loc)

  | Parsetree.Ppat_lazy pattern ->
     Ppat_lazy (of_parsetree_pattern pattern)

  | Parsetree.Ppat_unpack string_loc ->
     Ppat_unpack string_loc

  | Parsetree.Ppat_exception pattern ->
     Ppat_exception (of_parsetree_pattern pattern)

  | Parsetree.Ppat_extension extension ->
     Ppat_extension (of_parsetree_extension extension)
...
and of_parsetree_type_extension item = {
    ptyext_path= item.Parsetree.ptyext_path;
    ptyext_params= List.map (fun (core_type, variance) ->
                       (of_parsetree_core_type core_type,
                        of_parsetree_variance variance))
                            item.Parsetree.ptyext_params;

    ptyext_constructors=
      List.map of_parsetree_extension_constructor item.Parsetree.ptyext_constructors;

    ptyext_private= of_parsetree_private_flag item.Parsetree.ptyext_private;
    ptyext_attributes= of_parsetree_attributes item.Parsetree.ptyext_attributes;
  }
...
and of_parsetree_extension_constructor item =  {
    pext_name= item.Parsetree.pext_name;
    pext_kind= of_parsetree_extension_constructor_kind item.Parsetree.pext_kind;
    pext_loc= item.Parsetree.pext_loc;
    pext_attributes= of_parsetree_attributes item.Parsetree.pext_attributes;
  }
...
and of_parsetree_extension_constructor_kind = function
  | Parsetree.Pext_decl (constructor_arguments, core_type_option) ->
     Pext_decl (of_parsetree_constructor_arguments constructor_arguments,
                map_option of_parsetree_core_type core_type_option)

  | Parsetree.Pext_rebind longident_loc ->
     Pext_rebind longident_loc
...
and of_parsetree_class_type item = {
     pcty_desc= of_parsetree_class_type_desc item.Parsetree.pcty_desc;
     pcty_loc= item.Parsetree.pcty_loc;
     pcty_attributes= of_parsetree_attributes item.Parsetree.pcty_attributes;
    }
...
and of_parsetree_class_type_desc = function
  | Parsetree.Pcty_constr (longident_loc, core_type_list) ->
     Pcty_constr (longident_loc,
                  List.map of_parsetree_core_type core_type_list
                 )

  | Parsetree.Pcty_signature class_signature ->
     Pcty_signature (of_parsetree_class_signature class_signature)

  | Parsetree.Pcty_arrow (arg_label, core_type, class_type) ->
     Pcty_arrow (of_parsetree_arg_label arg_label,
                 of_parsetree_core_type core_type,
                 of_parsetree_class_type class_type)

  | Parsetree.Pcty_extension extension ->
     Pcty_extension (of_parsetree_extension extension)
...
and of_parsetree_class_signature item = {
    pcsig_self= of_parsetree_core_type item.Parsetree.pcsig_self;
    pcsig_fields= List.map of_parsetree_class_type_field item.Parsetree.pcsig_fields;
}
...
and of_parsetree_class_type_field item = {
    pctf_desc= of_parsetree_class_type_field_desc item.Parsetree.pctf_desc;
    pctf_loc= item.Parsetree.pctf_loc;
    pctf_attributes= of_parsetree_attributes item.Parsetree.pctf_attributes;
  }
...
and of_parsetree_class_type_field_desc = function
  | Parsetree.Pctf_inherit class_type ->
     Pctf_inherit (of_parsetree_class_type class_type)

  | Parsetree.Pctf_val (string_loc, mutable_flag, virtual_flag, core_type) ->
     Pctf_val (mknoloc string_loc,
               of_parsetree_mutable_flag mutable_flag,
               of_parsetree_virtual_flag virtual_flag,
               of_parsetree_core_type core_type
              )

  | Parsetree.Pctf_method (string_loc, private_flag, virtual_flag, core_type) ->
     Pctf_method (mknoloc string_loc,
                  of_parsetree_private_flag private_flag,
                  of_parsetree_virtual_flag virtual_flag,
                  of_parsetree_core_type core_type
                 )

  | Parsetree.Pctf_constraint (core_type1, core_type2) ->
     Pctf_constraint (of_parsetree_core_type core_type1,
                      of_parsetree_core_type core_type2
                     )

  | Parsetree.Pctf_attribute attribute ->
     Pctf_attribute (of_parsetree_attribute attribute)

  | Parsetree.Pctf_extension extension ->
     Pctf_extension (of_parsetree_extension extension)
...
and of_parsetree_class_structure item = {
    pcstr_self= of_parsetree_pattern item.Parsetree.pcstr_self;
    pcstr_fields= List.map of_parsetree_class_field item.Parsetree.pcstr_fields;
  }
...
and of_parsetree_class_field item = {
     pcf_desc= of_parsetree_class_field_desc item.Parsetree.pcf_desc;
     pcf_loc= item.Parsetree.pcf_loc;
     pcf_attributes= of_parsetree_attributes item.Parsetree.pcf_attributes;
  }
...
and of_parsetree_class_field_kind = function
  | Parsetree.Cfk_virtual core_type ->
     Cfk_virtual (of_parsetree_core_type core_type)
  | Parsetree.Cfk_concrete (override_flag, expression) ->
     Cfk_concrete (of_parsetree_override_flag override_flag,
                   of_parsetree_expression expression)
...
and of_parsetree_class_field_desc = function
  | Parsetree.Pcf_inherit (override_flag, class_expr, string_loc_option) ->
     Pcf_inherit (of_parsetree_override_flag override_flag,
                  of_parsetree_class_expr class_expr,
                  map_option mknoloc string_loc_option)
  | Parsetree.Pcf_val (string_loc, mutable_flag, class_field_kind) ->
     Pcf_val (string_loc,
              of_parsetree_mutable_flag mutable_flag,
              of_parsetree_class_field_kind class_field_kind
             )

  | Parsetree.Pcf_method (string_loc, private_flag, class_field_kind) ->
     Pcf_method (string_loc,
                 of_parsetree_private_flag private_flag,
                 of_parsetree_class_field_kind class_field_kind
                )

  | Parsetree.Pcf_constraint (core_type1, core_type2) ->
     Pcf_constraint (of_parsetree_core_type core_type1,
                     of_parsetree_core_type core_type2
                    )

  | Parsetree.Pcf_initializer expression ->
     Pcf_initializer (of_parsetree_expression expression)

  | Parsetree.Pcf_attribute attribute ->
     Pcf_attribute (of_parsetree_attribute attribute)

  | Parsetree.Pcf_extension extension ->
     Pcf_extension (of_parsetree_extension extension)
        (* [%%id] *)
...
and of_parsetree_module_type_declaration item = {
     pmtd_name= item.Parsetree.pmtd_name;
     pmtd_type= map_option of_parsetree_module_type item.Parsetree.pmtd_type;
     pmtd_attributes= of_parsetree_attributes item.Parsetree.pmtd_attributes;
     pmtd_loc= item.Parsetree.pmtd_loc;
    }
...
and of_parsetree_open_description item = {
    popen_lid= item.Parsetree.popen_lid;
    popen_override= of_parsetree_override_flag item.Parsetree.popen_override;
    popen_loc= item.Parsetree.popen_loc;
    popen_attributes= of_parsetree_attributes item.Parsetree.popen_attributes;
  }
...
and of_parsetree_class_type_declaration item = {
     pci_virt= of_parsetree_virtual_flag item.Parsetree.pci_virt;
     pci_params= List.map (fun (core_type, variance) ->
                               of_parsetree_core_type core_type,
                               of_parsetree_variance variance
                             ) item.Parsetree.pci_params;
     pci_name= item.Parsetree.pci_name;
     pci_expr= of_parsetree_class_type item.Parsetree.pci_expr;
     pci_loc= item.Parsetree.pci_loc;
     pci_attributes= of_parsetree_attributes item.Parsetree.pci_attributes;
    }

and to_parsetree_class_description item = to_parsetree_class_type_declaration item

and of_parsetree_class_description item = of_parsetree_class_type_declaration item
...
and of_parsetree_class_expr item = {
     pcl_desc= of_parsetree_class_expr_desc item.Parsetree.pcl_desc;
     pcl_loc= item.Parsetree.pcl_loc;
     pcl_attributes= of_parsetree_attributes item.Parsetree.pcl_attributes;
  }
...
and of_parsetree_class_expr_desc = function
  | Parsetree.Pcl_constr (longident_loc, core_type_list) ->
     Pcl_constr (longident_loc,
                 List.map of_parsetree_core_type core_type_list
                )

  | Parsetree.Pcl_structure class_structure ->
     Pcl_structure (of_parsetree_class_structure class_structure)

  | Parsetree.Pcl_fun (arg_label, expression_option, pattern, class_expr) ->
     Pcl_fun (of_parsetree_arg_label arg_label,
              map_option of_parsetree_expression expression_option,
              of_parsetree_pattern pattern,
              of_parsetree_class_expr class_expr
             )

  | Parsetree.Pcl_apply (class_expr, arg_label_expression_list) ->
     Pcl_apply (of_parsetree_class_expr class_expr,
                List.map (fun (arg_label, expression)->
                    (of_parsetree_arg_label arg_label,
                     of_parsetree_expression expression
                    )
  ...
  | Parsetree.Pcl_let (rec_flag, value_binding_list, class_expr) ->
     Pcl_let (of_parsetree_rec_flag rec_flag,
              List.map of_parsetree_value_binding value_binding_list,
              of_parsetree_class_expr class_expr
             )

  | Parsetree.Pcl_constraint (class_expr, class_type) ->
     Pcl_constraint (of_parsetree_class_expr class_expr,
                     of_parsetree_class_type class_type
                    )

  | Parsetree.Pcl_extension extension ->
     Pcl_extension (of_parsetree_extension extension)
...
and of_parsetree_class_declaration item = {
     pci_virt= of_parsetree_virtual_flag item.Parsetree.pci_virt;
     pci_params= List.map (fun (core_type, variance) ->
                               of_parsetree_core_type core_type,
                               of_parsetree_variance variance
     ...
     pci_name= item.Parsetree.pci_name;
     pci_expr= of_parsetree_class_expr item.Parsetree.pci_expr;
     pci_loc= item.Parsetree.pci_loc;
     pci_attributes= of_parsetree_attributes item.Parsetree.pci_attributes;
    }
...
and of_parsetree_module_type item = {
    pmty_desc= of_parsetree_module_type_desc item.Parsetree.pmty_desc;
    pmty_loc= item.Parsetree.pmty_loc;
    pmty_attributes= of_parsetree_attributes item.Parsetree.pmty_attributes;
  }
...
and of_parsetree_module_type_desc = function
  | Parsetree.Pmty_ident longident_loc ->
     Pmty_ident longident_loc

  | Parsetree.Pmty_signature signature ->
     Pmty_signature (of_parsetree_signature signature)

  | Parsetree.Pmty_functor (string_loc, module_type_option, module_type) ->
     Pmty_functor (string_loc,
                   map_option of_parsetree_module_type module_type_option,
                   of_parsetree_module_type module_type)

  | Parsetree.Pmty_with (module_type, with_constraint_list) ->
     Pmty_with (
         of_parsetree_module_type module_type,
         List.map of_parsetree_with_constraint with_constraint_list
       )

  | Parsetree.Pmty_typeof module_expr ->
     Pmty_typeof (of_parsetree_module_expr module_expr)

  | Parsetree.Pmty_extension extension ->
     Pmty_extension (
         of_parsetree_extension extension
       )
  | Parsetree.Pmty_alias longident_loc ->
     Pmty_alias longident_loc

and to_parsetree_signature items = List.map to_parsetree_signature_item items

and of_parsetree_signature items = List.map of_parsetree_signature_item items
...
and of_parsetree_signature_item item = {
     psig_desc= of_parsetree_signature_item_desc item.Parsetree.psig_desc;
     psig_loc= item.Parsetree.psig_loc;
    }
...
and to_parsetree_signature_item_desc = function
  ...
  | Psig_type (rec_flag, type_declaration_list) ->
     let open Parsetree in
     let list = List.map to_parsetree_type_declaration type_declaration_list in
     Psig_type (map_head (fun type_declaration -> {
                   type_declaration with
                   ptype_attributes =
                     add_nonrec
                       (to_parsetree_rec_flag rec_flag)
                       type_declaration.ptype_attributes
              }) list)
...
and of_parsetree_signature_item_desc = function
  | Parsetree.Psig_value value_description ->
     Psig_value (of_parsetree_value_description value_description)
  | Parsetree.Psig_type type_declaration_list ->
     let list = List.map of_parsetree_type_declaration type_declaration_list in
     let (flag, list) = match partition_nonrec_attr (List.hd list).ptype_attributes with
       | ([], _) -> (Recursive, list)
       | (_, attrs) -> (Nonrecursive,
                        map_head
                          (fun hd -> {
                               hd with
     ...
     Psig_type (flag, list)
  | Parsetree.Psig_typext type_extension ->
     Psig_typext (of_parsetree_type_extension type_extension)

  | Parsetree.Psig_exception extension_constructor ->
     Psig_exception (of_parsetree_extension_constructor extension_constructor)

  | Parsetree.Psig_module module_declaration ->
     Psig_module (of_parsetree_module_declaration module_declaration)

  | Parsetree.Psig_recmodule module_declaration_list ->
     Psig_recmodule (List.map of_parsetree_module_declaration module_declaration_list)

  | Parsetree.Psig_modtype module_type_declaration ->
     Psig_modtype (of_parsetree_module_type_declaration module_type_declaration)

  | Parsetree.Psig_open open_description ->
     Psig_open (of_parsetree_open_description open_description)

  | Parsetree.Psig_include include_description ->
     Psig_include (of_parsetree_include_description include_description)

  | Parsetree.Psig_class class_description_list ->
     Psig_class (List.map of_parsetree_class_description class_description_list)

  | Parsetree.Psig_class_type class_type_declaration_list ->
     Psig_class_type (List.map of_parsetree_class_type_declaration class_type_declaration_list)

  | Parsetree.Psig_attribute attribute ->
     Psig_attribute (of_parsetree_attribute attribute)

  | Parsetree.Psig_extension (extension, attributes) ->
     Psig_extension (of_parsetree_extension extension,
                     of_parsetree_attributes attributes
                    )
...
and of_parsetree_module_declaration item = {
     pmd_name= item.Parsetree.pmd_name;
     pmd_type= of_parsetree_module_type item.Parsetree.pmd_type;
     pmd_attributes= of_parsetree_attributes item.Parsetree.pmd_attributes;
     pmd_loc= item.Parsetree.pmd_loc;
}
...
and of_parsetree_include_description item = {
     pincl_mod= of_parsetree_module_type item.Parsetree.pincl_mod;
     pincl_loc= item.Parsetree.pincl_loc;
     pincl_attributes= of_parsetree_attributes item.Parsetree.pincl_attributes;
    }
...
and of_parsetree_include_declaration item = {
     pincl_mod= of_parsetree_module_expr item.Parsetree.pincl_mod;
     pincl_loc= item.Parsetree.pincl_loc;
     pincl_attributes= of_parsetree_attributes item.Parsetree.pincl_attributes;
    }
...
and of_parsetree_with_constraint = function
  | Parsetree.Pwith_type (longident_loc, type_declaration) ->
     Pwith_type (longident_loc,
                 of_parsetree_type_declaration type_declaration
                )

  | Parsetree.Pwith_module (longident_loc1, longident_loc2) ->
     Pwith_module (longident_loc1,
                   longident_loc2
                  )

  | Parsetree.Pwith_typesubst type_declaration ->
     Pwith_typesubst (of_parsetree_type_declaration type_declaration)

  | Parsetree.Pwith_modsubst (string_loc, longident_loc) ->
     Pwith_modsubst (string_loc, longident_loc)
...
and of_parsetree_module_expr item = {
    pmod_desc= of_parsetree_module_expr_desc item.Parsetree.pmod_desc;
    pmod_loc= item.Parsetree.pmod_loc;
    pmod_attributes= of_parsetree_attributes item.Parsetree.pmod_attributes;
  }
...
and of_parsetree_module_expr_desc = function
  | Parsetree.Pmod_ident longident_loc ->
     Pmod_ident longident_loc

  | Parsetree.Pmod_structure structure ->
     Pmod_structure (of_parsetree_structure structure)

  | Parsetree.Pmod_functor (string_loc, module_type_option, module_expr) ->
     Pmod_functor (string_loc,
                   map_option of_parsetree_module_type module_type_option,
                   of_parsetree_module_expr module_expr)

  | Parsetree.Pmod_apply (module_expr1, module_expr2) ->
     Pmod_apply (of_parsetree_module_expr module_expr1,
                 of_parsetree_module_expr module_expr2)

  | Parsetree.Pmod_constraint (module_expr, module_type) ->
     Pmod_constraint (of_parsetree_module_expr module_expr,
                      of_parsetree_module_type module_type)

  | Parsetree.Pmod_unpack expression ->
     Pmod_unpack (of_parsetree_expression expression)

  | Parsetree.Pmod_extension extension ->
     Pmod_extension (of_parsetree_extension extension)

and to_parsetree_structure structure =
  List.map to_parsetree_structure_item structure

and of_parsetree_structure structure =
  List.map of_parsetree_structure_item structure
...
and of_parsetree_structure_item item = {
    pstr_desc= of_parsetree_item_desc item.Parsetree.pstr_desc;
    pstr_loc= item.Parsetree.pstr_loc;
  }
...
and of_parsetree_item_desc = function
  | Parsetree.Pstr_eval (expression, attributes) ->
     Pstr_eval (of_parsetree_expression expression, of_parsetree_attributes attributes)

  | Parsetree.Pstr_value (rec_flag, value_binding_list) ->
     Pstr_value (of_parsetree_rec_flag rec_flag, List.map of_parsetree_value_binding value_binding_list)

  | Parsetree.Pstr_primitive value_description ->
     Pstr_primitive (of_parsetree_value_description value_description)

  | Parsetree.Pstr_type type_declaration_list ->
     let list = List.map of_parsetree_type_declaration type_declaration_list in
     let (flag, list) = match partition_nonrec_attr (List.hd list).ptype_attributes with
       | ([], _) -> (Recursive, list)
       | (_, attrs) -> (Nonrecursive,
  ...
  | Parsetree.Pstr_typext type_extension ->
     Pstr_typext (of_parsetree_type_extension type_extension)

  | Parsetree.Pstr_exception extension_constructor ->
     Pstr_exception (of_parsetree_extension_constructor extension_constructor)

  | Parsetree.Pstr_module module_binding ->
     Pstr_module (of_parsetree_module_binding module_binding)

  | Parsetree.Pstr_recmodule module_binding_list ->
     Pstr_recmodule (List.map of_parsetree_module_binding module_binding_list)

  | Parsetree.Pstr_modtype module_type_declaration ->
     Pstr_modtype (of_parsetree_module_type_declaration module_type_declaration)

  | Parsetree.Pstr_open open_description ->
     Pstr_open (of_parsetree_open_description open_description)

  | Parsetree.Pstr_class class_declaration_list ->
     Pstr_class (List.map of_parsetree_class_declaration class_declaration_list)

  | Parsetree.Pstr_class_type class_type_declaration_list ->
     Pstr_class_type (List.map of_parsetree_class_type_declaration class_type_declaration_list)

  | Parsetree.Pstr_include include_declaration ->
     Pstr_include (of_parsetree_include_declaration include_declaration)

  | Parsetree.Pstr_attribute attribute ->
     Pstr_attribute (of_parsetree_attribute attribute)

  | Parsetree.Pstr_extension (extension, attributes) ->
     Pstr_extension (of_parsetree_extension extension, of_parsetree_attributes attributes)
...
and of_parsetree_value_binding item = {
    pvb_pat= of_parsetree_pattern item.Parsetree.pvb_pat;
    pvb_expr= of_parsetree_expression item.Parsetree.pvb_expr;
    pvb_attributes= of_parsetree_attributes item.Parsetree.pvb_attributes;
    pvb_loc= item.Parsetree.pvb_loc;
  }
...
and of_parsetree_module_binding item = {
     pmb_name= item.Parsetree.pmb_name;
     pmb_expr= of_parsetree_module_expr item.Parsetree.pmb_expr;
     pmb_attributes= of_parsetree_attributes item.Parsetree.pmb_attributes;
     pmb_loc= item.Parsetree.pmb_loc;
    }
...
and of_parsetree_toplevel_phrase = function
  | Parsetree.Ptop_def structure ->
     Ptop_def (of_parsetree_structure structure)

  | Parsetree.Ptop_dir (string, directive_argument) ->
     Ptop_dir (string, of_parsetree_directive_argument directive_argument)
...
and of_parsetree_directive_argument = function
  | Parsetree.Pdir_none ->
     Pdir_none

  | Parsetree.Pdir_string string ->
     Pdir_string string

  | Parsetree.Pdir_int i ->
     Pdir_int (string_of_int i, None)

  | Parsetree.Pdir_ident longident_t ->
     Pdir_ident longident_t

  | Parsetree.Pdir_bool bool ->
     Pdir_bool bool
