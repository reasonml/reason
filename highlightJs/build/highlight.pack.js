...
hljs.registerLanguage('reason', function(hljs) {
  var SWIFT_KEYWORDS = {
      forDocGrammarHighlighting: 'ifTrue ifFalse expression testCondition startVal endVal typeConstraint argOneType argTwoType finalArgType typeStructure typeParam argOne argTwo finalArg argument argumentType expressionType identifier',
